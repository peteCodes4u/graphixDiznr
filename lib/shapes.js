...
class Hands {
    ...
    render(){
        return `<g transform="${this.d}<text font-family="Calibri" x="150" y="120" font-size="55" font-weight="bold" fill="white" style="stroke: black;" text-anchor="middle">`
    }
}
...
class Skull {
    ...
    render(){
        return `<g transform="${this.d}<text font-family="Calibri" x="270" y="555" font-size="155" font-weight="bold" fill="white" stroke= "black" stroke-width="5" text-anchor="middle">`
    }
}
...
class Bird {
    ...
    render(){
        return `<g transform="${this.d}<text font-family="Calibri" x="170" y="135" font-size="55" font-weight="bold" fill="white" style="stroke: black;" text-anchor="middle">`
    }
}
module.exports = { Circle, Square, Triangle, Heart, Hands, Skull, Bird };
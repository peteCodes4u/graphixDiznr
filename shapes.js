    ...
    if (logoShape == 'Circle') {
        ...
        if (logoShape == 'Square') {
            ...
            if (logoShape == 'Triangle') {
                ...
                imgShape = triangleHeader + '<polygon points="150,0 300,200 0,200"/>'
            } else {
                if (logoShape == 'Heart') {
                    imgShape = triangleHeader + '<path d="M 10, 30 a 20,20 0,0,1 40,0 a 20,20 0,0,1 40,0 Q 90,60 50,90 Q 10,60 10,30 z" />'
                } else {
                    if (logoShape == 'Skull') {
                        imgShape = skullHeader +
